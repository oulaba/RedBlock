...
def single_insertion(
    ...
    tokenized_w_wm_output[
        rand_insert_locs[0].item(): rand_insert_locs[0].item() + attack_len
    ] = tokenized_no_wm_output_cloned[rand_insert_locs[0].item(): rand_insert_locs[0].item()+attack_len]
...
#
#     tokenized_wm_output = torch.tensor(tokenized_wm_output)
#     tokenized_no_wm_output = torch.tensor(tokenized_no_wm_output)
